...
class AppellationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create appellation" do
    assert_difference('Appellation.count') do
      post appellations_url, params: { appellation: { location: @appellation.location, name: @appellation.name } }
    end
  ...
  test "should update appellation" do
    patch appellation_url(@appellation), params: { appellation: { location: @appellation.location, name: @appellation.name } }
